      ...
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={header}>
            <Heading style={brand}>AIE FASHIONZ</Heading>
            <Text style={tagline}>Luxury Fashion — UK</Text>
          </Section>
          ...
          <Section style={{ padding: "16px 0 24px" }}>
            ...
            {order.vat > 0 && (
              <Row style={{ marginBottom: "8px" }}>
                <Column><Text style={total_label}>VAT (20%)</Text></Column>
                <Column style={{ textAlign: "right" }}>
                  <Text style={total_value}>{formatCurrency(order.vat, currency)}</Text>
                </Column>
              </Row>
            )}
          ...
          <Section style={{ padding: "24px 0", textAlign: "center" }}>
            <Text style={footer_text}>
              ...
              <Link href="mailto:hello@aiefashionz.com" style={{ color: "#D4AF37" }}>
                hello@aiefashionz.com
              </Link>
            </Text>
            <Text style={footer_text}>
              14-day returns policy applies. Free returns for UK orders.
            </Text>
            <Text style={{ ...footer_text, marginTop: "16px", color: "#A8A7A3" }}>
              AIE Fashionz Ltd · United Kingdom
            </Text>
          </Section>
        </Container>
      </Body>
